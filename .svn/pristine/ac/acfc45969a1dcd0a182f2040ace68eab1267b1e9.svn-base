...
(function (undefined) {
    ...
    function newContext(contextName) {
        var context, resume,
            ...
            managerCallbacks = {},
            plugins = {},
        //Used to indicate which views in a build scenario
         ...
         * views that ask for it as a dependency. It needs to be specific
         ...
         * in the browser, where it may have many views defined in it.
         */
        ...
        function execManager(manager) {
            ...
            //of views executed and their dependencies.
        ...
        function getManager(map, shouldQueue) {
            ...
            if (prefix && !plugin) {
                ...
                pluginManager.add(function (plugin) {
                    ...
                    //views and dependencies, for instance, in a build.
        ...
        function main(inName, depArray, callback, relModuleMap) {
            ...
            if (fullName) {
                ...
                //Set specified/loaded here for views that are also loaded
        ...
        /**
         * Checks if all views for a context are loaded, and if so, evaluates the
        ...
        function checkLoaded() {
            ...
            if (expired && noLoads) {
                //If wait time expired, throw error of unloaded views.
                err = makeError("timeout", "Load timeout for views: " + noLoads);
            ...
            //If still have items in the waiting cue, but all views have
            ...
            if (context.waitCount) {
                ...
                //views waiting on it cannot finish loading, or some circular
        ...
        resume = function () {
            ...
            //Any defined views in the global queue, intake them now.
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                if (cfg.priority) {
                    ...
                    //But first, call resume to register any defined views that may
    ...
    /**
     * The function that handles definitions of views. Differs from
    ...
    define = function (name, deps, callback) {
        ...
        //This allows multiple views to be in a file without prematurely
    ...
    //works well in that environment, since require.min.js is normally
    ...
    //If views are built into require.min.js, then need to make sure dependencies are
    //traced. Use a setTimeout in the browser world, to allow all the views to register
    //themselves. In a non-browser env, assume that views are not built into require.min.js,

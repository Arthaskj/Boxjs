...
(function () {
    ...
    var v = ["break,continue,do,else,for,if,return,while"],
        ...
        J = [v, "alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,true,undef,unless,until,when,yield,BEGIN,END"],
        v = [v, "case,done,elif,esac,eval,fi,function,in,local,set,until"],
    ...
    window.prettyPrint = function (content, a) {
        function m() {
        ...
        for (var e = [content.find("pre"), content.find("code"), content.find("xmp")], h = [], k = 0; k < e.length; ++k) {

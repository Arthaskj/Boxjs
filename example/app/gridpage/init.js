Box.define('Demo.gridpage.init', {

    requires: [
        'Demo.gridpage.initDetail'
    ],
    ...
    setup: function () {
        var me = this;
        var gridPage = new Demo.gridpage.initDetail({
    ...
    searchFile: function () {
        this.CheckFile(this.el.text[0],'text!app/gridpage/initDetail.js');
    }

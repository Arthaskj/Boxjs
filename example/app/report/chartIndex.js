 ...
 *
 * ======================================================================== */
Box.define('Demo.report.chartIndex', {
    requires: [
        'Demo.report.common.chart'
    ],
    ...
    templates: {
        main: [
            '<div class="report" style="margin-left: 5px;margin-top: 40px">' +
            '<div class="cont">' +
            '</div>' +
            '<button class="k-button k-primary button">查看源代码</button>' +
            '<div class="text"></div> ' +
            '</div>'
        ]
    },
    ...
    setup: function () {
        ...
        this.bondTypeChart = new Demo.report.common.chart({
            renderTo: this.com_chart.el.content,
            width: '50%',
            height: '300px',
            option: {
                title: {
                ...
                tooltip: {
                    ...
                    formatter: function (params, ticket, callback) {
                        return params.name + ':' + Box.Format.renderWanYuan(params.value) + '万 (' + params.percent + '%)'
                    }
                },
                legend: {
                    type: 'scroll',
        ...
        this.top5Chart = new Demo.report.common.chart({
            renderTo: this.com_chart.el.content,
            width: '50%',
            height: '300px',
            option: {
        ...
        this.lineChart = new Demo.report.common.chart({
            renderTo: this.com_chart.el.content,
            width: '50%',
            height: '300px',
            option: {
        ...
        var maxData = 2000;
        this.chart = new Demo.report.common.chart({
            renderTo: this.com_chart.el.content,
            width: '50%',
            height: '300px',
            option:{
        ...
        var data=[
                {
                    "HoldAmtDayEnd": 10000000,
                    "StorageFaceAmt": null,
                    "AvailableFaceAmt": 10000000,
                    "FairValue": null,
                    "L2SecType": "地方政府债",
                    "BondName":"11国债"
                },
                {
                    "HoldAmtDayEnd": 20000000,
                    "StorageFaceAmt": null,
                    "AvailableFaceAmt": 20000000,
                    "FairValue": 20000000,
                    "L2SecType": "国债",
                    "BondName":"11国债"
                },
                ...
                {
                    "HoldAmtDayEnd": 16000000,
                    "StorageFaceAmt": null,
                    "AvailableFaceAmt": 16000000,
                    "FairValue": 16640000,
                    "L2SecType": "一般公司债",
                    "BondName":"11国债"
                },
                {
                    "HoldAmtDayEnd": 30000000,
                    "StorageFaceAmt": null,
                    "AvailableFaceAmt": 30000000,
                    "FairValue": null,
                    "L2SecType": "证监会主管ABS",
                    "BondName":"11国债"
                },
                ...
                {
                    "HoldAmtDayEnd": -6000000,
                    "StorageFaceAmt": null,
                    "AvailableFaceAmt": -6000000,
                    "FairValue": -5911349.9999994,
                    "L2SecType": "一般公司债",
                    "BondName":"11国债"
                },
                {
        ...
        this._setBondTypeChart(data);
        this._setTop5Chart(data);
        this._setLineChart();
        this._setChart();

    },

    _setBondTypeChart: function (data) {
        var bondType = data.groupBy('L2SecType');
        var legendData = [];
        var chartData = [];

        Box.Array.forEach(bondType, function (type) {
            legendData.push(type.L2SecType);
            chartData.push({
                name: type.L2SecType,
                value: type.items.sum('HoldAmtDayEnd')
            })
        }, this);

        this.bondTypeChart.setOption({
            legend: {
                data: legendData
            },
            series: [
    ...
    _setTop5Chart: function (data) {
        var sort = data.orderByDescending('HoldAmtDayEnd');
        var yLabel = [];
        var topData = [];

        for (var i = 0; i < (sort.length > 10 ? 10 : sort.length); i++) {
            yLabel.push(sort[i].BondName);
            topData.push(sort[i].HoldAmtDayEnd);
        }

        this.top5Chart.setOption({
            xAxis: {
                data: yLabel
            },
            series: [
    ...
    checkFile:function () {
        this.CheckFile(this.el.text[0],'text!app/report/chartIndex.js')
    }
